    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoldersScanJob", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FFileId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UniqueFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UniqueFiles_FFiles_FFileId",
                        column: x => x.FFileId,
                        principalTable: "FFiles",
                        principalColumn: "Id");
                });
